 ...
 * @author shaitozen
 */
public class AddEditUsersFrame extends javax.swing.JFrame {
    ...
    private void saveButton(){
        try {
            ...
            query = "INSERT INTO user_management(id, first_name, middle_name, last_name, age, username, password, user_type) VALUES(?,?,?,?,?,?,?,?)";
            ...
            pst.setString(8, cmbUserType.getSelectedItem().toString());  
            
            int k = pst.executeUpdate();
            
            if(k==1){
                JOptionPane.showMessageDialog(this, "Users Added");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEditUsersFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddEditUsersFrame().setVisible(true);
            }
        });
    }
